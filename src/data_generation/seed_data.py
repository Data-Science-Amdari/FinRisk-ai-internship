...
# Save datasets with helper
def save_csv(df, filename):
    """Save DataFrame to synthetic data folder"""
...
class FinRiskDataGenerator:
    ...
    def generate_all_datasets(self):
        ...
        save_csv(customers_df, "customer_profiles.csv")
        save_csv(bureau_df, "credit_bureau_data.csv")
        save_csv(applications_df, "credit_applications.csv")
        save_csv(transactions_df, "transaction_data.csv")
        save_csv(predictions_df, "model_predictions.csv")
